...
export const CATEGORIES = [
  { id: 1, name: 'Atta, Chawal & Dal', color: '#F4B400', image: require('../../assets/categories/atta_rice_dal.png') },
  { id: 2, name: 'Oil, Ghee & Masala', color: '#DB4437', image: require('../../assets/categories/oil_ghee_masala.png') },
  { id: 3, name: 'Namkeen & Snacks', color: '#F0932B', image: require('../../assets/categories/snacks.png') },
  { id: 4, name: 'Biscuit & Bakery', color: '#8E6E53', image: require('../../assets/categories/biscuit_bakery.png') },
  { id: 5, name: 'Noodles & Ready Food', color: '#F57C00', image: require('../../assets/categories/noodles_ready.png') },
  { id: 6, name: 'Chocolate & Toffee', color: '#6D4C41', image: require('../../assets/categories/chocolate.png') },
  { id: 7, name: 'Cold Drink & Beverages', color: '#1976D2', image: require('../../assets/categories/beverages.png') },
  { id: 8, name: 'Milk & Dairy', color: '#42A5F5', image: require('../../assets/categories/dairy.png') },
  { id: 9, name: 'Soap, Shampoo & Personal Care', color: '#9C27B0', image: require('../../assets/categories/personal_care.png') },
  { id: 10, name: 'Detergent & Cleaning', color: '#00ACC1', image: require('../../assets/categories/cleaning.png') },
  { id: 11, name: 'Baby Care', color: '#FF80AB', image: require('../../assets/categories/baby_care.png') },
  { id: 12, name: 'Pooja & Daily Use', color: '#7E57C2', image: require('../../assets/categories/pooja.png') },
  { id: 13, name: 'Stationery & Others', color: '#546E7A', image: require('../../assets/categories/stationery.png') },
  { id: 14, name: 'Offers & Combo', color: '#2E7D32', image: require('../../assets/categories/offers.png') },
];
